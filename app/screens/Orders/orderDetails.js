                ...
                <View style={styles.background}>
                    <SafeAreaView style={[
                        ...
                        <View style={{ top: 60, flex: 1, backgroundColor: '#f2f2f2' }}>
                            ...
                            <View style={{ alignItems: 'center', justifyContent: 'center', paddingVertical: 10, backgroundColor: '#4a9f03', width: '100%' }}>
                            ...
                            <View style={{ paddinHorizontal: 10 }}>
                                <View style={{
                                    flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', backgroundColor: '#fff', borderRadius: 8,
                                    paddingHorizontal: 10, paddingVertical: 5, width: '100%', marginBottom: 10
                                }}>
                                    <View>
                                        <Label Color={'#959595'} FontSize={12} TextAlign={'left'} style={{ fontWeight: 'normal' }}>
                                            Order No: 2011-1
</Label>
                                        <Label Color={'#959595'} FontSize={12} TextAlign={'left'} style={{ fontWeight: 'normal' }}>
                                            Total Items: 03
